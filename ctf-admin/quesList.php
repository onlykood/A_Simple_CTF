            ...
            success:function(data){
                ...
                $.each(
                    ...
                    function(num,content){
                        ...
                        $('<td class="td-manage">').html('<a title="编辑" onclick="x_admin_show(\'编辑\',\'quesEdit.php?id='+content.id+'\',800,400)" href="javascript:;"><i class="layui-icon">&#xe642;</i></a><a title="动态flag" onclick="x_admin_show(\'动态flag\',\'flagCalc.php?id='+content.id+'\',800,400)"><i class="layui-icon">&#xe614;</i></a>').appendTo(trow);
                        trow.appendTo( tbody );
                    }
                );
